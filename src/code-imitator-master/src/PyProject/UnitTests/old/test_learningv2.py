...
class TestFeatureExtraction(unittest.TestCase):
    ...
    def test_usenix_rf(self):
        ...
        configuration_learning: ConfigurationLearning = ConfigurationLearning(
            ...
            suffix_data="_2017_8_2_formatted_macrosremoved",
        ...
        self.assertAlmostEqual(c1, 1.0, delta=0.0001)

        #self.assertAlmostEqual(c2, 0.675454, delta=10e-5)
        self.assertAlmostEqual(c2, 0.9595685, delta=0.0001)

        #self.assertAlmostEqual(c3, 0.722788, delta=10e-5)
        self.assertAlmostEqual(c3, 1.0055621, delta=0.0001)

        #self.assertAlmostEqual(c4, 0.0432594, delta=10e-5)
        self.assertAlmostEqual(c4, 0.098647773, delta=0.0001)

        #self.assertAlmostEqual(c5, 22.0, delta=10e-5)
        self.assertAlmostEqual(c5, 18.54167, delta=0.0001)

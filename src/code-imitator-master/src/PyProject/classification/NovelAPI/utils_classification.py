...
def perform_standard_classification_for_split(features_merged: StyloFeatures, #features_merged2: StyloFeatures,
    ...
    print(testfiles.getauthors(),file=sys.stderr)
    #print(testfiles.getiids(),file=sys.stderr)
    # exit()
    #testfiles: StyloFeatures = features_merged2[test_index]
    ...
    # print("TEST ACC",file=sys.stderr)
    # print(currentaccuracy,file=sys.stderr)
